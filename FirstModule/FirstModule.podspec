#
# Be sure to run `pod lib lint FirstModule.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jackson/FirstModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jackson' => 'jackson.smith@sanar.com' }
  s.source           = { :git => 'https://github.com/Jackson/FirstModule.git', :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'FirstModule' => ['ios/Assets/*.png', 'ios/*.js']
  }
